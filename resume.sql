...
(2, 'inv.JPG', '<h5>發票兌獎系統</h5>\r\n<small class=\"text-info\">主要程式語言:PHP。功能:紀錄發票資料，統計當月支出，可單張發票兌獎，也可整月一起兌獎，有後台功能。</small>', 'http://220.128.133.15/s1090416/Invoice220/'),
(3, 'anaClock.JPG', '<h5>類比時鐘</h5>\r\n<small class=\"text-info\">主要使用js及css撰寫</small>', 'http://220.128.133.15/s1090416/analogClock220/'),
(4, 'cal.JPG', '<h5>萬年曆</h5>\r\n<small class=\"text-info\">主要使用php。可查詢想要的年份及月分。</small>', 'http://220.128.133.15/s1090416/calender220/'),
(5, 'drink.JPG', '<h5>小動畫</h5>\r\n<small class=\"text-info\">主要使用css Animation。</small>', 'http://220.128.133.15/s1090416/drinkAnimation220/');
